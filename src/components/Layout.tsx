        ...
        <nav className="hidden md:flex items-center gap-12">
          {navLinks.map((link) => (
            ...
            >
              <Link 
                to={link.to} 
                className={`text-[11px] uppercase tracking-widest font-black transition-all duration-300 ${isScrolled || !isHome || isMenuOpen ? (location.pathname === link.to ? "text-brand-blue" : "text-brand-dark/70 hover:text-brand-blue") : (location.pathname === link.to ? "text-brand-blue" : "text-white/80 hover:text-white")}`}
              >
                {link.label}
              </Link>
                      ...
                      <div className="bg-white border border-brand-border p-12 min-w-[900px] grid grid-cols-3 gap-16 rounded-[32px] shadow-2xl">
                        {productMegaMenu.map((section) => (
                          <div key={section.title}>
                            <h4 className="text-[10px] font-black text-brand-dark/30 uppercase tracking-widest mb-8 border-b border-brand-border pb-4">
                              {section.title}
                            </h4>
          ...
          >
            <nav className="flex flex-col gap-10 overflow-y-auto pb-20">
              ...
              >
                <Link 
                  to="/contact" 
                  className="inline-block px-12 py-4 rounded-full bg-brand-blue text-white font-mono text-[10px] uppercase tracking-[0.4em] hover:bg-brand-blue/90 transition-all"
                  onClick={() => setIsMenuOpen(false)}
                >
                  {t("nav.contact")}
                </Link>
    ...
    <footer className="bg-white py-32 px-6 md:px-20 border-t border-brand-border relative overflow-hidden">
      <div className="max-w-[1800px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-24">
          ...
          <div>
            <h4 className="text-[11px] font-black mb-10 text-brand-dark/30 tracking-widest uppercase">{t("footer.quick_links")}</h4>
          ...
          <div>
            <h4 className="text-[11px] font-black mb-10 text-brand-dark/30 tracking-widest uppercase">{t("footer.core_series")}</h4>
            <ul className="space-y-5 text-brand-dark/70 text-[13px] font-bold">
          ...
          <div>
            <h4 className="text-[11px] font-black mb-10 text-brand-dark/30 tracking-widest uppercase">
              {t("footer.subscribe")}
            </h4>
            ...
            <div className="relative">
              ...
              <button className="absolute right-0 bottom-5 text-[11px] font-black text-brand-dark/30 uppercase tracking-widest hover:text-brand-blue transition-colors">
                Join
              </button>
            </div>
          </div>
        ...
        <div className="pt-12 border-t border-brand-border flex flex-col md:flex-row justify-between items-center gap-8 text-brand-dark/20 text-[11px] uppercase tracking-widest font-black">
          <p>{t("footer.rights")}</p>
