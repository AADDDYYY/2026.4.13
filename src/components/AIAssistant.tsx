    ...
    try {
      const response = await ai.models.generateContent({
        ...
        contents: [
          {
            role: "user",
            parts: [{ text: "你现在是西顿新材料（SEACRYL）的 AI 技术助手。你的任务是为客户提供关于水性树脂、聚氨酯乳液、丙烯酸乳液等产品的技术咨询。西顿新材料是一家专注于高性能水性聚合物研发的全球领先企业。你的回答应该专业、严谨且富有商业礼仪。如果客户询问特定产品，你可以提到 SEACRYL（丙烯酸）、SEAPUR（聚氨酯）等系列。如果遇到无法回答的深度技术问题，请建议客户联系我们的技术专家团队（sales@seaton.com.cn）。请使用用户咨询时使用的语言进行回答。" }]
          },
          ...messages.map(m => ({
